...
const envSchema = z.object({
  ...
  DEPLOY_WORKER_CONCURRENCY: z.coerce.number().int().min(1).max(10).default(2),
  ...
  FILE_MANAGER_UPLOAD_LIMIT_BYTES: z.coerce.number().int().positive().default(1024 * 1024 * 1024),
