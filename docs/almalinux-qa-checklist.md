...
- [ ] Wildcard subdomain SSL does not send `domain-*.example.com` as a sysagent vhost name; it shows the DNS-01 requirement until DNS provider automation is implemented
